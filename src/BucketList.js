...
export class BucketList extends Component{
    ...
    handleClick(eventKey){
        if(eventKey.target.name === "logout"){
            ...
            axios.post('http://10.142.0.2:8000/auth/logout')
            .then( response => {
            })
            .catch( error => {
    ...
    componentWillMount(){
        ...
        var authorizationValue = {
          ...
          axios.get('http://10.142.0.2:8000/bucketlists/?page=1', authorizationValue
        ).then( response => {
            let buttonArray = [];
    ...
    updateTable(){
        ...
        if (this.state.bucketIDCreateActivity != null )
            {
            axios.get('http://10.142.0.2:8000/bucketlists/' + this.state.bucketIDCreateActivity +'/items/?page=1', authorizationValue
            ).then( response => {
    ...
    handleChange(e){
        ...
        if (e.target.name === "searchBucket")
            ...
            if (e.target.value !== '')
                ...
                axios.get('http://10.142.0.2:8000/bucketlists/?q='+ e.target.value,
    ...
    openActivities(event){
        ...
        axios.get('http://10.142.0.2:8000/bucketlists/' + event.target.value +'/items/?page=1', authorizationValue
        ).then( response => {
            let buttonArray = [];
            if(response.data["pages"] > 1 ){
                for ( let i=1; i <= response.data["pages"]; i++){
    ...
    handleSubmit(event){
        ...
        if (event.target.name === "createBucketForm")
            {
            axios.post('http://10.142.0.2:8000/bucketlists/', {name: this.state.new_bucket}, authorizationValue
            ).then( response => {
                this.setState({
                    createBucketError: '',
                ...
                axios.get('http://10.142.0.2:8000/bucketlists/' + event.target.value +'/items/', authorizationValue
                ).then( response => {
                    this.setState({
        ...
        if (event.target.name === "editBucketForm")
            {
            axios.put('http://10.142.0.2:8000/bucketlists/' + this.state.editBucketID,
        ...
        if (event.target.name === "deleteBucketForm")
            {
            axios.delete('http://10.142.0.2:8000/bucketlists/' + this.state.deleteBucketID,
                         authorizationValue
            ).then( response => {
                this.setState({
        ...
        if(event.target.name === "createActivityForm")
            ...
            axios.post('http://10.142.0.2:8000/bucketlists/'+urlString,
        ...
        if(event.target.name === "editActivityForm")
            {
            axios.put('http://10.142.0.2:8000/bucketlists/' + this.state.bucketIDCreateActivity + '/items/' +
        ...
        if(event.target.name === "deleteActivityForm")
            {
            axios.delete('http://10.142.0.2:8000/bucketlists/' + this.state.bucketIDCreateActivity + '/items/'+
    ...
    open(e) {
        ...
        if (e.target.name ==="searchButton")
            ...
            axios.get('http://10.142.0.2:8000/bucketlists/' + e.target.id +'/items/?page=1', authorizationValue
            ).then( response => {
                let buttonArray = [];
                if(response.data["pages"] > 1 ){
                    for ( let i=1; i <= response.data["pages"]; i++){
    ...
    handlePages(event){
        ...
        axios.get('http://10.142.0.2:8000/bucketlists/?page=' + event.target.value, authorizationValue
        ).then( response => {
            let buttonArray = [];
            for ( let i=1; i <= response.data["pages"]; i++){
                buttonArray.push(i);
    ...
    handleActivityPages(event){
        ...
        axios.get('http://10.142.0.2:8000/bucketlists/' + event.target.id +'/items/?page=' + event.target.value, authorizationValue
        ).then( response => {
            let buttonArray = [];
            if(response.data["pages"] > 1 ){
                for ( let i=1; i <= response.data["pages"]; i++){
