...
export class BucketList extends Component{
    ...
    componentWillMount(){
        ...
        var authorizationValue = {
          ...
          axios.get(process.env.REACT_APP_URL + 'bucketlists/?page=1', authorizationValue
        ).then( response => {
            let buttonArray = [];
    ...
    updateTable(){
        ...
        if (this.state.bucketIDCreateActivity != null )
            {
            axios.get(process.env.REACT_APP_URL + 'bucketlists/' + this.state.bucketIDCreateActivity +'/items/?page=1', authorizationValue
            ).then( response => {
    ...
    handleChange(e){
        ...
        if (e.target.name === "searchBucket")
            ...
            if (e.target.value !== '')
                ...
                axios.get(process.env.REACT_APP_URL + 'bucketlists/?q='+ e.target.value,
    ...
    openActivities(event){
        ...
        axios.get(process.env.REACT_APP_URL + 'bucketlists/' + event.target.value +'/items/?page=1', authorizationValue
        ).then( response => {
            let buttonArray = [];
            if(response.data["pages"] > 1 ){
                for ( let i=1; i <= response.data["pages"]; i++){
    ...
    handleSubmit(event){
        ...
        if (event.target.name === "createBucketForm")
            {
            axios.post(process.env.REACT_APP_URL + 'bucketlists/', {name: this.state.new_bucket}, authorizationValue
            ).then( response => {
                this.setState({
                    createBucketError: '',
                ...
                axios.get(process.env.REACT_APP_URL + 'bucketlists/' + event.target.value +'/items/', authorizationValue
                ).then( response => {
                    this.setState({
        ...
        if (event.target.name === "editBucketForm")
            {
            axios.put(process.env.REACT_APP_URL + 'bucketlists/' + this.state.editBucketID,
        ...
        if (event.target.name === "deleteBucketForm")
            {
            axios.delete(process.env.REACT_APP_URL + 'bucketlists/' + this.state.deleteBucketID,
                         authorizationValue
            ).then( response => {
                this.setState({
        ...
        if(event.target.name === "createActivityForm")
            ...
            axios.post(process.env.REACT_APP_URL + 'bucketlists/'+urlString,
        ...
        if(event.target.name === "editActivityForm")
            {
            axios.put(process.env.REACT_APP_URL + 'bucketlists/' + this.state.bucketIDCreateActivity + '/items/' +
        ...
        if(event.target.name === "deleteActivityForm")
            {
            axios.delete(process.env.REACT_APP_URL + 'bucketlists/' + this.state.bucketIDCreateActivity + '/items/'+
    ...
    open(e) {
        ...
        if (e.target.name ==="searchButton")
            ...
            axios.get(process.env.REACT_APP_URL + 'bucketlists/' + e.target.id +'/items/?page=1', authorizationValue
            ).then( response => {
                let buttonArray = [];
                if(response.data["pages"] > 1 ){
                    for ( let i=1; i <= response.data["pages"]; i++){
    ...
    handlePages(event){
        ...
        axios.get(process.env.REACT_APP_URL + 'bucketlists/?page=' + event.target.value, authorizationValue
        ).then( response => {
            let buttonArray = [];
            for ( let i=1; i <= response.data["pages"]; i++){
                buttonArray.push(i);
    ...
    handleActivityPages(event){
        ...
        axios.get(process.env.REACT_APP_URL + 'bucketlists/' + event.target.id +'/items/?page=' + event.target.value, authorizationValue
        ).then( response => {
            let buttonArray = [];
            if(response.data["pages"] > 1 ){
                for ( let i=1; i <= response.data["pages"]; i++){
